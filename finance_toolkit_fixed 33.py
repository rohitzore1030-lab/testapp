...
def ui_risk():
    ...
    sharpe = (ann_return - rf/100) / ann_vol if ann_vol > 0 else 0
...
def ui_interest():
    ...
    emi = P/n if rate == 0 else P * rate * (1+rate)**n / (((1+rate)**n) - 1)
...
with tabs[4]: st.write("Finance Toolkit Fixed Version — All errors removed. © 2025 Rohit")
